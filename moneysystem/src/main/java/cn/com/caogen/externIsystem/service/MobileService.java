...
public class MobileService {
    ...
    public static final String key ="b42ad72b834fd72639be85588559cc84";//申请的接口Appkey
    public static final String openId="JHf8ef3853f3ff3b8ca6fe370bbe173e04";//在个人中心查询
...
//---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public static String onlineOrder(String phone,int cardnum,String orderid) throws Exception{
        ...
        String sign = Md5Util.strToMD5(openId+key+phone+cardnum+orderid);
    ...
    public static String yuE() throws Exception{
        ...
        String sign = Md5Util.strToMD5(openId+key+timestamp);
