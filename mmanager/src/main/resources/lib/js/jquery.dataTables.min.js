...
oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"No data available in table",sInfo:"当前显示 _START_到_END_条  总共 _TOTAL_ 条",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每页显示 _MENU_  条",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"搜索关键字:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
...
" ui-corner-bl ui-corner-br"});var Mb=m.ext.pager;h.extend(Mb,{simple:function(){return["上一页","下一页"]},full:function(){return["第一页","上一页","下一页","最后一页"]},numbers:function(a,b){return[Aa(a,b)]},simple_numbers:function(a,b){return["previous",Aa(a,b),"next"]},full_numbers:function(a,b){return["第一页","上一页",Aa(a,b),"下一页","最后一页"]},_numbers:Aa,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||
{},k,l,m=0,p=function(b,d){var n,r,t,s,v=function(b){Ta(a,b.data.action,true)};n=0;for(r=d.length;n<r;n++){s=d[n];if(h.isArray(s)){t=h("<"+(s.DT_el||"div")+"/>").appendTo(b);p(t,s)}else{k=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "第一页":k=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "上一页":k=j.sPrevious;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "下一页":k=j.sNext;l=s+(e<f-1?"":" "+g.sPageButtonDisabled);break;case "最后一页":k=
